...
register(
	defineModel({
		...
		label: 'HSI',
		family: 'hue',
		ctor: { name: 'HSI', params: [p('h'), p('s'), p('i')], build: ([h, s, i]) => ({ mode: 'hsi', h, s, i }) as unknown as CuloriColor },
		channels: [
...
register(
	defineModel({
		...
		priority: 'high',
		ctor: { name: 'OKHSL', params: [p('h'), p('s'), p('l')], build: ([h, s, l]) => ({ mode: 'okhsl', h, s, l }) as unknown as CuloriColor },
		channels: [
...
register(
	defineModel({
		...
		label: 'Okhsv',
		family: 'perceptual-cylindrical',
		ctor: { name: 'OKHSV', params: [p('h'), p('s'), p('v')], build: ([h, s, v]) => ({ mode: 'okhsv', h, s, v }) as unknown as CuloriColor },
		channels: [
...
register(
	defineModel({
		...
		label: 'Cubehelix',
		family: 'hue',
		ctor: { name: 'CUBEHELIX', params: [p('h'), p('s'), p('l')], build: ([h, s, l]) => ({ mode: 'cubehelix', h, s, l }) as unknown as CuloriColor },
		channels: [
